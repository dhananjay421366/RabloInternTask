      ...
      <div className="mx-auto my-8 flex w-full max-w-sm flex-col px-4">
        ...
        <div className="w-full">
          ...
          <input
            id="avatar"
            type="file"
            className="w-full p-1 file:mr-4 file:border-none file:bg-[#ae7aff] file:px-3 file:py-1.5 mb-4 rounded-lg border bg-transparent px-3 py-2"
        ...
        <button
          className="bg-[#ae7aff] px-4 py-3 text-black flex justify-center"
